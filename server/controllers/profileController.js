...
exports.updateProfile = async (req, res, next) => {
    try {
        ...
        // destructure
        const { description, iconURI, bannerURI, currentExp, platformsCreated, quizzesTaken, quizzesCreated, quizzesScore, level, likedQuizzes, subscribedUsers, subscribedPlatforms, fans } = req.body.profile;
        ...
        switch (MODE) {
            case "EDIT":
                provided = nonNullJson({ description, iconURI, bannerURI, currentExp, level });
